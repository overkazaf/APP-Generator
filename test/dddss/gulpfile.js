...
gulp.task('dev', function() {
    ...
    new webpackDevServer(compiler, {
        ...
        open('http://172.16.24.181:' + defaultSettings.port + '/webpack-dev-server/dddssPages/Test/index.html');
    })
});
...
gulp.task('checkPrebuild', ['prebuild', 'copyPrebuildFiles'], function() {
    ...
    return deferedCheckPrebuild(function() {
        sendEmail({
            subject: 'dddss build task has been successfully completed on master branch.',
            html: '<p>Project dddss will be updated in a minute; Have a nice day! ;D  --sent from John </p>'
        });
    }, function() {
        defered.reject();
    });
